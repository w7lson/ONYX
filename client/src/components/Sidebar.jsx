...
import {
    ...
    BarChart3, ChevronLeft, ChevronRight, Globe,
} from 'lucide-react';
...
export default function Sidebar() {
    ...
    const renderNavLink = ({ to, icon: Icon, labelKey }) => (
        <NavLink
            ...
            to={to}
            className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-150 whitespace-nowrap ${
                    isActive
                        ? 'text-white'
    ...
    return (
        <motion.aside
            ...
            className="h-screen bg-[#111318] border-r border-white/[0.06] flex flex-col sticky top-0"
        >
            {/* Header */}
            ...
            <div className="py-3 px-2 flex flex-col gap-0.5 shrink-0">
                <div ref={accountRef} className="relative">
                    ...
                    {/* Language popup — same level as account popup, to its right */}
